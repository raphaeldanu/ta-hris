...
class UserPolicy
{
    ...
    {
        return $user->role->permissions->contains('name', 'view_any_users');
    }
    ...
    {
        return $user->role->permissions->contains('name', 'delete_user') && $user->id != $model->id;
    }
    ...
    {
        return $user->role->permissions->contains('name', 'change_password') && $user->id != $model->id;
    }
